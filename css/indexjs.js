	...
	$(document).ready(function(){
		...
		$(".play").click(function(){
			sel = setInterval(function(){ $(".nextBtn").click(); },4000);
			// 기본 이미지 : 일러스트2.png
		...
		*/
		$(".prd_inn ul").children("li").mouseover(function(){	
			$("#products p").show().addClass("pro_text").css({
				"left":$(this).offset().left,
				"top":$(this).offset().top
			}).children("a").text($(this).find("a").attr("title")).mouseout(function(){
		...
		*/
		...
		$(".artArea li").click(function(){
			...
			$("#view").find("a").css({"backgroundImage":$(this).children("a").children("span").css("backgroundImage")});
			console.log($(this));
